...
import {Fonts, AppStyles, Metrics, Images, Colors} from '../../theme';
export default function VoiceRecorderView(props) {
  ...
  return (
    <>
      <Spinner
        visible={showFetchLoader}
        color={Colors.green}
        overlayColor={'rgba(255,255,255,.85)'}
        textContent="Please wait while we are fetching results ......"
        textStyle={{
          textAlign: 'center',
          color: 'black',
          fontSize: 21,
      ...
      <LinearGradient
        ...
        <View
          style={[AppStyles.mTop25, {paddingHorizontal: Metrics.baseMargin}]}>
          <Text
